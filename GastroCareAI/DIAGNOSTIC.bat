...
title GastroCare AI - DIAGNOSTIC
...
echo.
echo  ================================================================
echo   GastroCare AI  -  FULL DIAGNOSTIC TOOL
echo  ================================================================
echo.
echo GastroCare AI Diagnostic > "%RPT%"
...
call :SEC "4. FILES"
for %%F in ("server.py" "static\index.html" "modules\ai_providers.py" "START_GastroCare_AI.bat") do (
...
if %errorlevel%==0 (call :OK "  Server IS running on port %PORT%") else (call :WARN "  Server NOT running - start with START_GastroCare_AI.bat")
call :SEC "6. SECURITY"
...
if not "%ANTHROPIC_API_KEY%"=="" (call :OK "  ANTHROPIC_API_KEY: Set") else (call :WARN "  No server default key - configure providers in Settings (5 options)")
echo.
echo  ================================================================
...
if /i "%DC%"=="S" call "%BASEDIR%\START_GastroCare_AI.bat" & exit /b 0
if /i "%DC%"=="X" exit /b 0
goto :DM
:SEC
