...
echo.
echo  ================================================================
echo   GastroCare AI  -  UPDATE TOOL
echo  ================================================================
...
echo   [ OK ]  Online.
if not exist "%VENV_DIR%\Scripts\pip.exe" (echo   [FAIL]  Venv not found. Run START_GastroCare_AI.bat first. & pause & exit /b 1)
...
echo.
echo  ================================================================
echo   Update complete. Restart GastroCare AI to use new packages.
echo  ================================================================
echo.
pause
