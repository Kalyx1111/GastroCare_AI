...
call :LOG "===== GastroCare AI Launch Started %DATE% %TIME% ====="
cls
echo.
echo  ================================================================
echo   GastroCare AI  -  Gastroenterology Health Intelligence v1.0
echo  ================================================================
echo.
echo  MEDICAL DISCLAIMER:
echo  This is an AI Research Tool ONLY. Not medical advice.
echo  ALWAYS consult your gastroenterologist before any decision.
echo  GI EMERGENCY: Call 112 (India) / 999 (UK) / 911 (US)
echo  Vomiting blood, black stools, severe abdominal pain: CALL NOW.
echo.
echo  ================================================================
echo.
...
echo.
echo  [STEP 7/7]  Starting GastroCare AI...
...
start "GastroCare AI Server" cmd /k "echo GastroCare AI Server - Keep Open && "%VPYTHON%" "%BASEDIR%\server.py" --port %PORT%"
...
echo.
echo  ================================================================
echo   DISCLAIMER: Research only. Consult your gastroenterologist.
...
goto :MENU
:QUIT
taskkill /FI "WINDOWTITLE eq GastroCare AI Server*" /F >nul 2>&1
